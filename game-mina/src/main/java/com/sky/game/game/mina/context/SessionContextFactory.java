...
@JmxResource(domainName="com.sky.game.context",beanName="SessionContextFactory",description=" Mina Server IoSession Context.")
public class SessionContextFactory  implements IGameConnectionStateChanged{
