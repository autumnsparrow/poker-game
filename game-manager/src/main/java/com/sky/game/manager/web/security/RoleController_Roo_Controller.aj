...
import com.sky.game.manager.web.security.RoleController;
...
privileged aspect RoleController_Roo_Controller {
    ...
    public String RoleController.create(@Valid Authority authority, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String RoleController.update(@Valid Authority authority, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, authority);
    ...
    void RoleController.populateEditForm(Model uiModel, Authority authority) {
