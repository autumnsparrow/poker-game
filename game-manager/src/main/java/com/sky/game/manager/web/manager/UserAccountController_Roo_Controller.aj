...
import com.sky.game.manager.web.manager.UserAccountController;
...
privileged aspect UserAccountController_Roo_Controller {
    ...
    void UserAccountController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("userAccount_updatetime_date_format", DateTimeFormat.patternForStyle("MM", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("userAccount_createtime_date_format", DateTimeFormat.patternForStyle("MM", LocaleContextHolder.getLocale()));
    }
